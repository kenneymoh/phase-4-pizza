...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference("Pizza.count") do
      post pizzas_url, params: { pizza: { ingredients: @pizza.ingredients, name: @pizza.name } }, as: :json
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { ingredients: @pizza.ingredients, name: @pizza.name } }, as: :json
    assert_response :success
  end
